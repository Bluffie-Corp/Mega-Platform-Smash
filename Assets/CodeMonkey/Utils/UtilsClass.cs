...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static FunctionUpdater CreateWorldTextUpdater(Func<string> GetTextFunc, Vector3 localPosition, Transform parent = null) {
            var textMesh = CreateWorldText(GetTextFunc(), parent, localPosition);
        ...
        public static void CreateWorldTextPopup(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, Vector3 finalPopupPosition, float popupTime) {
            var textMesh = CreateWorldText(parent, text, localPosition, fontSize, color, TextAnchor.LowerLeft, TextAlignment.Left, sortingOrderDefault);
        ...
        public static void ShakeCamera(float intensity, float timer) {
            ...
            FunctionUpdater.Create(delegate () {
                ...
                var randomMovement = new Vector3(UnityEngine.Random.Range(-1f, 1f), UnityEngine.Random.Range(-1f, 1f)).normalized * intensity;
